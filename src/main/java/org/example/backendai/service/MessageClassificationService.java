...
public class MessageClassificationService {
    ...
    public MessageClassificationResponse classifyMessage(Integer patientId, String messageContent) {
        ...
        // 5. Map label từ AI sang SeverityLevel enum
